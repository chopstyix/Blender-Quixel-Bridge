        ...
        try:
            ...
            if globals()['Megascans_DataSet'] != None:
                ...
                for js in self.json_Array:
                    ...
                    # For some reason Quixel resets the scene fps to 25, this might be due to an unreal engine fbx error as described in
                    # https://projects.blender.org/blender/blender/issues/50399
